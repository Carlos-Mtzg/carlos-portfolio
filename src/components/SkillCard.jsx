...
const SkillCard = ({ name, icon: Icon, custom }) => {
  return (
    <div className="cursor-target flex flex-col items-center justify-center border border-transparent transition-all hover:border-secondary-600 hover:scale-[1.1] bg-white/10 rounded-xl shadow-md p-6 cursor-pointer group">
